        ...
        <div>
                ...
                <div className="2xl:container  2xl:mx-auto lg:py-16 md:py-12 md:px-6 py-9 px-4">
                    ...
                    <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
                        <div className="w-full lg:w-6/12">
                            <h1 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">About International College of Auckland
                            </h1>
                            <p className="font-normal text-base leading-6 text-gray-600 mt-6">The International College of Auckland (ICA) is an NZQA accredited Private Training Establishment (PTE) established under the Education Act of 1989 in 2002 with two campuses – Auckland and Hamilton.

                                ICA offers courses in English Language (New Zealand Certificate in English Language and Migrant English), Information Technology, and Engineering Programmes. ICA is also the only private training establishment to offer the full range of engineering courses – Civil, Mechanical, and Electrical Engineering.</p>
                        </div>
                        <div className="w-full lg:w-6/12">
                    ...
                    <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
                        <div>
                            <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">Established (2002)</p>
                            <p className="font-normal text-base leading-6 text-gray-600 mt-6">NZQA accredited Private Training Establishment (PTE) established under the Education Act of 1989 in 2002 </p>
                        </div>
                        <div>
                            <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">Campuses (Two)</p>
                            <p className="font-normal text-base leading-6 text-gray-600 mt-6">It has total two campuses. One in Auckland and second one in  Hamilton</p>
                        </div>
                        <div className="sm:block hidden">
                            <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">Multiple Courses</p>
                            <p className="font-normal text-base leading-6 text-gray-600 mt-6"> ICA is also the only private training establishment to offer the full range of engineering courses</p>
                        </div>
                    </div>
                    ...
                    <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
                        <div className="w-full lg:w-6/12">
                            <h2 className="font-bold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800">Mission Statement</h2>
                            <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">To provide quality education which enables students to optimise their potential and become internationally competitive in the market place.

                            </p>

                            <h2 className="font-bold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 mt-10">Vision Statement</h2>
                            <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">To be a world-class education provider by thoroughly meeting the stakeholder’s needs through its education delivery.



                            </p>

                            <h2 className="font-bold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 mt-10">ICA Strategic Alliances</h2>
                        ...
                        <div className="w-full lg:w-6/12">
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
                                ...
                                <div className="flex p-4 shadow-md">
                                    ...
                                    <div className="">
                                        <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800">Staff</p>
                                        <p className="mt-2 font-normal text-base leading-6 text-gray-600">Most of our teaching staff hold a doctoral degree or are PhD candidates.The English tutors in Auckland are qualified tutors with CELTA or TESOL certificates. Most of English tutors hold a master degree or above in English language teaching or relevant field.  </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex p-4 shadow-md">
                                    ...
                                    <div className="">
                                        <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800">Alliances
                                        </p>
                                        <p className="mt-2 font-normal text-base leading-6 text-gray-600">ICA maintains strategic, academic, industry and community alliances with various organisations. Students benefit from alliances that pool and integrate resources, guidance and intellect to provide quality education and produce desired outcomes such as employment or further studies options.
            ...
            <div className="bg-indigo-600 px-4 py-3 text-white">
                <p className="text-center text-sm font-medium">
                    EER Report visit!
                    <a href="#" className="inline-block underline pl-2">Click Here</a>
                </p>
            </div>
            <div className='max-w-7xl mx-auto mb-10' >
                <h1 className="text-4xl font-bold text-center mt-20 pb-10"> <span className="font-serif italic">Support, Development and Achievement</span>
                </h1>
                <p className='text-center px-8 md:px-12 lg:px-32'>

                    ICA students come from all over the world and having a mixture of different cultures enable ICA to form a diverse and harmonious international family. ICA offers a unique educational environment that focuses on individual development and achievement. The classes are average in number but still small enough to make students feel like a valuable member of the ICA family.

                    Quality teaching from our qualified staff, a supportive environment, and a multi-cultural experience provide a framework for the success of the students. ICA recognises each student and the continuing contribution they make to the society at a local and global level. The variety of ICA programmes enable a pathway for students to both domestic and international opportunities in business employment and higher education.

                    ICA students are inspired to discover and apply their intellectual and creative potential to responsibly contribute to the society. As students, they will learn to reason, adapt, innovate, communicate, and develop so they can respond to the rapid changes in the modern workforce.

                    In ICA, students will have an excellent opportunity to learn in a modern and stimulating environment. Having the interest of the students’ future in mind, ICA is determined to work closely with stakeholders and relevant organisations to create opportunities for the students of all departments – Engineering (Civil, Mechanical, and Electrical), Information Technology, and English.                </p>
