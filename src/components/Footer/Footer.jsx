            ...
            <footer >
                ...
                <section className="py-10  bg-white">
                    <div className="container px-4  mx-auto max-w-7xl">
                        <div className="max-w-7xl mb-10  mx-auto">
                            <div className="pb-10 mb-10 border-b border-gray-700 items-center">
                                <div className="flex flex-wrap -mx-4 items-center">
                                    <div className="w-full lg:w-1/2 px-4 mb-4 lg:mb-0">
                                        <Link to="/">
                                            <img className="h-15" src={logo} alt="ICA Logo" />
                                        </Link>
                                    </div>
                                    <div className="w-full lg:w-1/2 px-4">
                                        <div className="sm:flex -mb-4 items-center lg:justify-end">
                                            <span className="inline-block text-black mb-4 mr-8">Still have confusions?</span>
                                            <a className="relative group inline-block w-full sm:w-auto py-3 px-5 mb-4 text-center text-sm font-semibold text-lime-50 hover:text-lime-900 bg-lime-900 rounded-md overflow-hidden transition duration-300" href="#">
                                                ...
                                                <span className="relative">Give Us A Call</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-wrap -mx-4 mb-18">
                                <div className="w-full lg:w-2/5 px-4 mb-12 lg:mb-0">
                                    <div className="xs:max-w-xs">
                                        <h4 className="font-heading text-2xl font-semibold text-black mb-4">Subscribe to our newsletter</h4>
                                        <form action="">
                                            <label className="block mb-1.5 text-sm font-semibold text-black" >Email</label>
                                            <div className="xs:flex items-center">
                                                <div className="relative mb-4 xs:mb-0 xs:mr-4">
                                                    ...
                                                    <input className="w-full p-12 pr-4 py-4 text-sm text-black placeholder-gray-700 rounded-lg bg-gray-100 border border-gray-700 outline-none" type="email" placeholder="xyz@gmail.com" />
                                                </div>
                                                <button className="flex flex-shrink-0 ml-auto xs:ml-0 items-center justify-center w-12 h-12 text-lime-50 hover:text-lime-900 bg-lime-900 hover:bg-gray-300 rounded-full transition duration-200" type="submit">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="w-full sm:w-1/3 lg:w-1/5 px-4 mb-8 sm:mb-0">
                                    <h5 className="text-lg font-semibold text-black mb-4">Student Services</h5>
                                    <ul>
                                        <li className="mb-4"><Link className="inline-block text-black hover:text-lime-700" to="/student-services/students-placement-support">Students Placement</Link></li>
                                        <li className="mb-4"><Link className="inline-block text-black hover:text-lime-700" to="/student-services/safety-in-the-city">Safety in the City</Link></li>
                                        <li className="mb-4"><Link className="inline-block text-black hover:text-lime-700" to="/student-services/career-support">Career Support</Link></li>
                                        <li><Link className="inline-block text-black hover:text-lime-700" to="/student-services/icasa">ICASA</Link></li>
                                    </ul>
                                </div>
                                <div className="w-full sm:w-1/3 lg:w-1/5 px-4 mb-8 sm:mb-0">
                                    <h5 className="text-lg font-semibold text-black mb-3">About</h5>
                                    <ul>
                                        <li className="mb-4"><Link className="inline-block text-black hover:text-lime-700" to="/about-us/mentoring-system">Mentoring System</Link></li>
                                        <li className="mb-4"><Link className="inline-block text-black hover:text-lime-700" to="/about-us/our-school">Our School</Link></li>
                                        <li className="mb-4"><Link className="inline-block text-black hover:text-lime-700" to="/about-us/staff">Our Staff</Link></li>
                                        <li><Link className="inline-block text-black hover:text-lime-700" to="/about-us/our-booklet">Our booklet</Link></li>
                                    </ul>
                                </div>
                                <div className="w-full sm:w-1/3 lg:w-1/5 px-4">
                                    <h5 className="text-lg font-semibold text-black mb-4">Help</h5>
                                    <ul>
                                        <li className="mb-4"><Link className="inline-block text-black hover:text-lime-700" to="/contact-us/faqs">Faqs</Link></li>
                                        <li><Link className="inline-block text-black hover:text-lime-700" to="/contact-us/faqs">Contact</Link></li>
                                    </ul>
                                </div>
                            </div>
                            <div className="sm:flex items-center justify-between">
                                <div className="sm:flex mb-6 sm:mb-0 items-center"><a className="inline-block mr-6 sm:mr-12 text-black hover:text-lime-700" href="#">Terms & Conditions</a><a className="inline-block text-black hover:text-lime-700" href="#">Privacy Policy</a></div>
                        ...
                        <div className="pt-10 border-t border-gray-200">
                            <div className="lg:flex items-center">
                                ...
                                <div className="text-center w-full"><p>Created By ❤️ Fasih</p></div>
